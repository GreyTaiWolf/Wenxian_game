...
export const enemyTemplates: EnemyTemplate[] = [
  {
    ...
    name: "山狼",
    kind: "beast",
    stats: { maxHp: 80, maxSpirit: 16, attack: 15, defense: 7, divineSense: 3, speed: 16, dodge: 0, crit: 0.05, critDamage: 1.5 },
  ...
  },
  {
    ...
    name: "守草妖兽",
    kind: "beast",
    stats: { maxHp: 110, maxSpirit: 24, attack: 18, defense: 10, divineSense: 4, speed: 12, dodge: 0, crit: 0.04, critDamage: 1.5 },
  ...
  },
  {
    ...
    stats: { maxHp: 130, maxSpirit: 30, attack: 22, defense: 11, divineSense: 12, speed: 14, dodge: 0, crit: 0.06, critDamage: 1.5 },
  ...
  },
  {
    ...
    name: "洞府石卫",
    kind: "beast",
    stats: { maxHp: 180, maxSpirit: 34, attack: 26, defense: 18, divineSense: 8, speed: 9, dodge: 0, crit: 0.03, critDamage: 1.5 },
    skillIds: ["bite", "pounce", "beast_roar"],
  },
  {
    id: "venom_vine",
    name: "妖藤",
    kind: "beast",
    stats: { maxHp: 150, maxSpirit: 24, attack: 24, defense: 12, divineSense: 6, speed: 10, dodge: 0, crit: 0.04, critDamage: 1.5 },
    skillIds: ["bite", "pounce", "beast_roar"],
  },
  {
    id: "miasma_gu",
    name: "瘴蛊虫",
    kind: "beast",
    stats: { maxHp: 125, maxSpirit: 28, attack: 26, defense: 9, divineSense: 5, speed: 22, dodge: 0, crit: 0.08, critDamage: 1.5 },
    skillIds: ["bite", "pounce", "beast_roar"],
  },
  {
    id: "mountain_yao",
    name: "山魈",
    kind: "beast",
    stats: { maxHp: 190, maxSpirit: 34, attack: 31, defense: 16, divineSense: 8, speed: 18, dodge: 0, crit: 0.07, critDamage: 1.5 },
    skillIds: ["bite", "pounce", "beast_roar"],
  },
  {
    id: "tide_guard",
    name: "潮汐守卫",
    kind: "enemyCultivator",
    stats: { maxHp: 210, maxSpirit: 38, attack: 32, defense: 18, divineSense: 14, speed: 13, dodge: 0, crit: 0.05, critDamage: 1.5 },
    skillIds: ["basic_strike", "qi_slash", "leaf_spell"],
  },
  {
    ...
    name: "南疆妖修",
    kind: "enemyCultivator",
    stats: { maxHp: 170, maxSpirit: 40, attack: 27, defense: 15, divineSense: 18, speed: 16, dodge: 0, crit: 0.06, critDamage: 1.5 },
    skillIds: ["basic_strike", "qi_slash", "leaf_spell"],
  },
  {
    id: "wood_puppet",
    name: "木傀",
    kind: "beast",
    stats: { maxHp: 220, maxSpirit: 26, attack: 30, defense: 22, divineSense: 10, speed: 8, dodge: 0, crit: 0.03, critDamage: 1.5 },
    skillIds: ["bite", "pounce", "beast_roar"],
  },
];
