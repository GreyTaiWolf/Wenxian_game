...
const baseItems: BaseItemConfig[] = [
  ...
  {
    id: "healing_powder_recipe",
    name: "回春散丹方",
    category: "recipe",
    tier: "qi",
    grade: "fan",
    description: "记录回春散的基础火候与药材比例，研读后可在洞府丹炉炼制。",
    basePrice: 28,
  },
  {
    id: "qi_pill_recipe",
    ...
    tier: "qi",
    grade: "liang",
    description: "低阶炼丹师常用丹方，研读后可在洞府丹炉炼制聚气丹。",
    basePrice: 120,
  },
  {
    ...
    tier: "foundation",
    grade: "ling",
    description: "记载筑基丹的护炉与凝丹要诀，至少需要一阶丹炉方可炼制。",
    basePrice: 305.45,
  },
  {
    id: "qingyun_token",
  ...
  {
    id: "rough_iron_sword_blueprint",
    name: "粗铁剑图纸",
    category: "blueprint",
    tier: "mortal",
    grade: "fan",
    description: "赵家炼器铺常用图纸，研读后可在炼器台打造粗铁剑。",
    basePrice: 24,
  },
  {
    id: "low_sword",
  ...
  {
    id: "low_sword_blueprint",
    name: "低阶法剑图纸",
    category: "blueprint",
    tier: "qi",
    grade: "liang",
    description: "记录低阶法剑的淬火与引灵步骤，研读后可在炼器台打造低阶法剑。",
    basePrice: 100,
  },
